...
double GeometricHierarchical::computeAverageLength(ConnectedDotGraph& g, const VN& v1, const VN& v2)
{
	VD avg;
...
vector<vector<DotNode*> > GeometricHierarchical::cluster(ConnectedDotGraph& g, int K)
{
	assert(K >= 1);
